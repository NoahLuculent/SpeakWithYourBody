  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4">
        ...
        {/* Input Card */}
        <div
          className="glass-card rounded-2xl p-8 w-full max-w-lg animate-scale-in"
        ...
        {/* Instructions */}
        <div
          className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 w-full max-w-2xl animate-fade-in"
          ...
          {[
            {
              step: "1",
              title: "Train",
              desc: "Create poses in Teachable Machine",
            },
            { step: "2", title: "Upload", desc: "Paste your model URL above" },
            {
              step: "3",
              title: "Play",
              desc: "Match poses before time runs out!",
            },
          ].map((item) => (
